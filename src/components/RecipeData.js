...
import RecipesList from './SearchForm/recipesList';
                ...
                return(
                    <Card className={classes.root} className={styles.singleCardMaterialUI}>
                        ...
                        />
                            ...
                            <Link to={`Search/${recipe.id}`} className={styles.link}>
                                <CardMedia className={classes.media} image={recipe.photoURL} />
                            </Link>
                            <CardContent>
                                ...
                                <div className={styles.cardBottom}>
                                    ...
                                    <div className={styles.icons}>
                                    <AttachMoneyIcon style={{ fontSize: '1.75rem' }} />: {recipe.price}{' '}
                                    zł 
                                    </div>
